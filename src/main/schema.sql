...
)ENGINE =InnoDB AUTO_INCREMENT=100000 DEFAULT CHARSET =utf8 COMMENT ='图书管理系统用户信息表';
...
)ENGINE =InnoDB AUTO_INCREMENT =100000 DEFAULT CHARSET =utf8 COMMENT ='图书信息表';
...
)ENGINE =InnoDB AUTO_INCREMENT =100000 DEFAULT CHARSET = utf8 COMMENT ='借阅信息表';